...
const VideoModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isUserProvided': PropertySchema(
      id: 1,
      name: r'isUserProvided',
      type: IsarType.bool,
    ),
...
void _videoModelSerialize(
  ...
  writer.writeBool(offsets[1], object.isUserProvided);
  writer.writeLong(offsets[2], object.lastPositionMs);
...
VideoModel _videoModelDeserialize(
  ...
  object.id = id;
  object.isUserProvided = reader.readBool(offsets[1]);
  object.lastPositionMs = reader.readLong(offsets[2]);
...
extension VideoModelQueryWhere
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterWhereClause> idGreaterThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension VideoModelQueryFilter
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition>
  isUserProvidedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'isUserProvided', value: value),
      );
    });
  }
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> updatedAtEqualTo(
    DateTime? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> updatedAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> updatedAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterFilterCondition> urlIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension VideoModelQuerySortBy
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> sortByIsUserProvided() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isUserProvided', Sort.asc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy>
  sortByIsUserProvidedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isUserProvided', Sort.desc);
    });
  }
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> sortByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.desc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> sortByUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.asc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> sortByUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension VideoModelQuerySortThenBy
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> thenByIsUserProvided() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isUserProvided', Sort.asc);
    });
  }
  ...
  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> thenByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.desc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> thenByUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.asc);
    });
  }

  QueryBuilder<VideoModel, VideoModel, QAfterSortBy> thenByUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.desc);
    });
  }
...
extension VideoModelQueryWhereDistinct
  ...
  QueryBuilder<VideoModel, VideoModel, QDistinct> distinctByIsUserProvided() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isUserProvided');
    });
  }
  ...
  QueryBuilder<VideoModel, VideoModel, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'updatedAt');
    });
  }

  QueryBuilder<VideoModel, VideoModel, QDistinct> distinctByUrl({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension VideoModelQueryProperty
  ...
  QueryBuilder<VideoModel, bool, QQueryOperations> isUserProvidedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isUserProvided');
    });
  }
  ...
  QueryBuilder<VideoModel, DateTime?, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'updatedAt');
    });
  }

  QueryBuilder<VideoModel, String, QQueryOperations> urlProperty() {
    return QueryBuilder.apply(this, (query) {
